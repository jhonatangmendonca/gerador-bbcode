                    ...
                    if ($resultado) {
                        if ($resultado->num_rows > 0) {
                            while ($linha = $resultado->fetch_assoc()) {
                                ...
                                echo "[b]País de Origem: [/b]" . $linha["Pais"] . "\n";
                                echo "[b]Diretor: [/b]" . $linha["Diretor"] . "\n";
                                echo "[b]Gêneros: [/b]" . $linha["Genero"] . "\n";
                                echo "[b]Lançamento: [/b]" . $linha["Data"] . "\n";
                                echo "[/" . $alinhamentoTexto . "]";
                                echo "\n";
                                echo "\n";
                                echo "[" . $alinhamentoTag . "]";
                    ...
                    if ($resultado->num_rows > 0) {
                        while ($linha = $resultado->fetch_assoc()) {
                            ...
                            <div class="col s12 m12 l12 <?php echo $alinhamentoTexto ?> mb-5">
                                ...
                                <b>País de Origem: </b><?php echo $linha["Pais"] ?><br />
                                <b>Diretor: </b><?php echo $linha["Diretor"] ?><br />
                                <b>Gêneros: </b><?php echo $linha["Genero"] ?><br />
                                <b>Lançamento: </b><?php echo $linha["Data"] ?>
                            </div>

...
<body>
    ...
    <main class="container" style="margin-top: 80px;margin-bottom: 80px;">
        <form class="center-align" action="https://cliente.####.club/enviar-fotos.php" method="post" target="_blank">
            <textarea id="descrCopia" style="margin-top: -1000px;">
<?php
$idInserido =  $_GET["idInserido"];

$query = "SELECT T.*, AP.*, A.* FROM fotosxxx AP 
...
if ($resultado) {
    if ($resultado->num_rows > 0) {
        while ($linha = $resultado->fetch_assoc()) {
            ...
            echo "[b]Número de Páginas: [/b]" . $paginas . "\n";
            echo "[b]Tipo de Publicação: [/b]" . $publicacao . "\n";
            echo "[b]Data da Publicação: [/b]" . $data . "\n";
            echo "[b]Idioma do Conteúdo: [/b]" . $idioma . "\n";
            echo "[b]Formato do Arquivo: [/b]" . $genero . "\n";
            echo "[b]Gênero: [/b]" . $extensao . "";
            echo "[/" . $alinhamentoTexto . "]";
            echo "\n";
            if ($assinatura != "") {
                    ...
                    if ($resultado->num_rows > 0) {
                        while ($linha = $resultado->fetch_assoc()) {
                            ...
                            <div class="col s12 m12 l12  <?php echo $alinhamentoTexto ?> mb-5">
                                <img width="300" src="<?php echo $capa ?>">
                            </div>
                            ...
                            <div class="col s12 m12 l12  <?php echo $alinhamentoTexto ?> mb-5">
                                ...
                                <b>Número de Páginas: </b><?php echo $paginas ?><br />
                                <b>Tipo de Publicação: </b><?php echo $publicacao ?><br />
                                <b>Data da Publicação: </b><?php echo $data ?><br />
                                <b>Idioma do Conteúdo: </b><?php echo $idioma ?><br />
                                <b>Gênero: </b><?php echo $genero ?><br />
                                <b>Formato do Arquivo: </b><?php echo $extensao ?><br />
                            </div>

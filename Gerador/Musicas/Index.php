...
<body>
    ...
    <header style="position: fixed; height: 56px !important; z-index: 10; width: 100vw; top:0">
        <nav style="background-color: transparent; box-shadow: none;">
            ...
            <div class="black darken-2">
                ...
                <span class="breadcrumb grey-text lighten-5">Músicas</span>
    ...
    <main>
        <div Class="row center-align">
            <?php
            if ($idUsuario == 1) {
                $query = " SELECT M.Pk, M.Artista, M.Capa ,M.Album , U.NomeUsuario, U.Pk As 'PkUsuario' 
                FROM musicas M Join usuarios U ON M.FkUsuario = U.Pk 
                Order By U.Pk, M.Artista";
                $resultado = $CONEXAO->query($query);
                if ($resultado) {
                    if ($resultado->num_rows > 0) {
                        while ($linha = $resultado->fetch_assoc()) {
            ?>
                            <div class="col s6 m4 l3" style="justify-content: center;display: flex;">
                                <div class="card small tooltipped" data-position="top" data-tooltip="<?php echo $linha["Artista"] ?> - <?php echo $linha["Album"] ?>" style="width: 200px;height: 200;background-image: url('<?php echo $linha["Capa"] ?>');background-size: contain;background-repeat: round; background-color: black">
                                    <?php if ($linha["PkUsuario"] == 1) { ?>
                                        <div class="card-content" style="justify-content: space-around;position: absolute;bottom: 0;width: 100%;display: flex;">
                                            <a href="Musica.php?idInserido=<?php echo $linha["Pk"]; ?>" data-position="top" data-tooltip="Ver Bbcode" class="btn-floating halfway-fab waves-effect waves-light green darken-4 tooltipped"><i class="material-icons">visibility</i></a>
                                        ...
                                        <p class="card-titulo"><?php echo $linha["Artista"] ?> - <?php echo $linha["Album"] ?></p>
                                    <?php } else { ?>
                                        <div class="card-content" style="justify-content: space-around;position: absolute;bottom: 0;width: 100%;display: flex;">
                                            <div class="d-flex align-content-between flex-wrap bntLancamentos">
                                                <a href="Musica.php?idInserido=<?php echo $linha["Pk"]; ?>" data-position="top" data-tooltip="Ver Bbcode" class="tooltipped">
                ...
                if ($resultado) {
                    if ($resultado->num_rows > 0) {
                        ...
                        ?>
                            <div class="col s6 m4 l3" style="justify-content: center;display: flex;">
                                <div class="card small tooltipped" data-position="top" data-tooltip="<?php echo $linha["Artista"] ?> - <?php echo $linha["Album"] ?>" style="width: 200px;height: 200;background-image: url('<?php echo $linha["Capa"] ?>'); background-size: cover; background-repeat: no-repeat; background-color: black">
                                    <div class="card-content" style="justify-content: space-around;position: absolute;bottom: 0;width: 100%;display: flex;">
                                        <a href="Musica.php?idInserido=<?php echo $linha["Pk"]; ?>" data-position="top" data-tooltip="Ver Bbcode" class="btn-floating halfway-fab waves-effect waves-light green darken-4 tooltipped"><i class="material-icons">visibility</i></a>
                                        <a href="Editar.php?idInserido=<?php echo $linha["Pk"]; ?>" data-position="top" data-tooltip="Editar Descrição" class="btn-floating halfway-fab waves-effect waves-light blue darken-4 tooltipped"><i class="material-icons">mode</i></a>
                                        <a onclick="fnDeletaLancamento(<?php echo $linha['Pk']; ?>)" data-position="top" data-tooltip="Excluir Descrição" class="btn-floating halfway-fab waves-effect waves-light red darken-4 tooltipped"><i class="material-icons btn-excluir-item">delete</i></a>

...
$query = "SELECT * FROM tv Where Pk = $idInserido";
$resultado = $CONEXAO->query($query);
if ($resultado) {
    while ($linha = $resultado->fetch_assoc()) {
        $Titulo = $linha["Titulo"];
...
<body>
    ...
    <header style="position: fixed; height: 56px !important; z-index: 10; width: 100vw; top:0">
        <nav style="background-color: transparent; box-shadow: none;">
            ...
            <div class="black darken-2">
                ...
                <a class="breadcrumb white-text" href="./Index.php">Televisão</a>
    ...
    <main class="container" style="margin-top: 80px;margin-bottom: 80px;">
        <form class="form-group" action="Gera.php" method="post">
            ...
            <div class="row">
                <div class="input-field col s12 m6 l6 xl6">
                    <input value="<?php echo $Direcao ?>" id="direcao" name="direcao" type="text" class="validate" required="">
            ...
            <div class="row">
                ...
                <div class="input-field col s6">
                    ...
                    <select class="browser-default" id="legenda" name="legenda" required="">
                        <option value="Alemao" <?= ($Legenda == 'Alemao') ? 'selected' : '' ?>>Alemão</option>
                        <option value="Chines" <?= ($Legenda == 'Chines') ? 'selected' : '' ?>>Chinês</option>
                        ...
                        <option value="Ingles" <?= ($Legenda == 'Ingles') ? 'selected' : '' ?>>Inglês</option>
                        ...
                        <option value="Sem Legenda" <?= ($Legenda == 'Sem Legenda') ? 'selected' : '' ?>>Sem Legenda</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="input-field col s6">
                    ...
                    <select class="browser-default" id="idiomaOriginal" name="idiomaOriginal" required="">
                        <option value="Alemao" <?= ($IdiomaOriginal == 'Alemao') ? 'selected' : '' ?>>Alemao</option>
                        <option value="Chines" <?= ($IdiomaOriginal == 'Chines') ? 'selected' : '' ?>>Chines</option>
                        <option value="Coreano" <?= ($IdiomaOriginal == 'Coreano') ? 'selected' : '' ?>>Coreano</option>
                        <option value="Espanhol" <?= ($IdiomaOriginal == 'Espanhol') ? 'selected' : '' ?>>Espanhol</option>
                        <option value="Inglês" <?= ($IdiomaOriginal == 'Inglês') ? 'selected' : '' ?>>Inglês</option>
                        <option value="Japones" <?= ($IdiomaOriginal == 'Japones') ? 'selected' : '' ?>>Japones</option>
                        <option value="Outros" <?= ($IdiomaOriginal == 'Outros') ? 'selected' : '' ?>>Outros</option>
                        <option value="Português PT" <?= ($IdiomaOriginal == 'Português PT') ? 'selected' : '' ?>>Português PT</option>
                        <option value="Português BR" <?= ($IdiomaOriginal == 'Português BR') ? 'selected' : '' ?>>Português BR</option>
                        <option value="Russo" <?= ($IdiomaOriginal == 'Russo') ? 'selected' : '' ?>>Russo</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row">
                <div class="input-field col s12">
                    <textarea id="musicas" name="musicas" class="materialize-textarea"><?php echo str_replace("<br />", "", $Musicas) ?></textarea>

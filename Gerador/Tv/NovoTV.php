    ...
    <header style="position: fixed; height: 56px !important; z-index: 10; width: 100vw; top:0">
        <nav style="background-color: transparent; box-shadow: none;">
            ...
            <div class="black darken-2">
                ...
                <span class="breadcrumb grey-text lighten-5">Novo Televisão</span>
            </div>
        </nav>
    </header>
        ...
        <form action="gera.php" method="post" class="p-3">
            ...
            <div class="row">
                <div class="input-field col s12 m6 l6 xl6">
                    ...
                    <select class="browser-default" id="codecAudio" name="codecAudio" required="">
                        <option value="" disabled selected>Selecione...</option>
                ...
                <div class="input-field col s12 m6 l6 xl6">
                    ...
                    <select class="browser-default" id="codecVideo" name="codecVideo" required="">
                        <option value="" disabled selected>Selecione...</option>
            ...
            <div class="row">
                ...
                <div class="input-field col s12 m6 l6 xl6">
                    ...
                    <select class="browser-default" id="legenda" name="legenda" required="">
                        ...
                        <option value="Sem Legenda">Sem Legenda</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row">
                <div class="input-field col s12">
                    <textarea id="elenco" name="elenco" class="materialize-textarea"></textarea>

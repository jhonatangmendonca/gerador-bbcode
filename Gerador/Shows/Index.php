...
<body>
    ...
    <header style="position: fixed; height: 56px !important; z-index: 10; width: 100vw; top:0">
        <nav style="background-color: transparent; box-shadow: none;">
            ...
            <div class="black darken-2">
                ...
                <span class="breadcrumb grey-text lighten-5">Show</span>
    ...
    <main>
        <div Class="row center-align">
            <?php
            if ($idUsuario == 1) {
                $query = " SELECT S.Pk, S.Capa, S.Titulo, U.NomeUsuario, U.Pk As 'PkUsuario'  
            FROM shows S Join usuarios U ON S.FkUsuario = U.Pk 
            Order By U.Pk, S.Titulo";
                $resultado = $CONEXAO->query($query);
                if ($resultado) {
                    if ($resultado->num_rows > 0) {
                        while ($linha = $resultado->fetch_assoc()) {
                                ...
                                <div class="card small tooltipped" data-position="top" data-tooltip="<?php echo $linha["Titulo"] ?>" style="width: 200px;height: 280;background-image: url('<?php echo $linha["Capa"] ?>'); background-size: cover; background-repeat: round;  background-color: black">
                                    <?php if ($linha["PkUsuario"] == 1) { ?>
                                        <div class="card-content" style="justify-content: space-around;position: absolute;bottom: 0;width: 100%;display: flex;">
                                            <a href="Show.php?idInserido=<?php echo $linha["Pk"]; ?>" data-position="top" data-tooltip="Ver Bbcode" class="btn-floating halfway-fab waves-effect waves-light green darken-4 tooltipped"><i class="material-icons">visibility</i></a>
                                    ...
                                    <?php } else { ?>
                                        <div class="card-content" style="justify-content: space-around;position: absolute;bottom: 0;width: 100%;display: flex;">
                                            <div class="d-flex align-content-between flex-wrap bntLancamentos">
                                                <a href="Show.php?idInserido=<?php echo $linha["Pk"]; ?>" data-position="top" data-tooltip="Ver Bbcode" class="tooltipped">

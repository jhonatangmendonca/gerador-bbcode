    ...
    <header style="position: fixed; height: 56px !important; z-index: 10; width: 100vw; top:0">
        <nav style="background-color: transparent; box-shadow: none;">
            ...
            <div class="black darken-2">
                ...
                <span class="breadcrumb grey-text lighten-5">Animes</span>
            </div>
        </nav>
    </header>
    ...
    <main>
        <div Class="row center-align">
            ...
            if ($idUsuario == 1) {
                ...
                FROM animes A Join usuarios U ON A.FkUsuario = U.Pk 
                                ...
                                <div class="card small tooltipped" data-position="top" data-tooltip="<?php echo $linha["Titulo"] ?>" style="width: 200px;height: 280;background-image: url('<?php echo $linha["Capa"] ?>'); background-size: contain; background-repeat: round;  background-color: black">
                                    <?php if ($linha["PkUsuario"] == 1) { ?>
                                        <div class="card-content" style="justify-content: space-around;position: absolute;bottom: 0;width: 100%;display: flex;">
                                            <a href="Anime.php?idInserido=<?php echo $linha["Pk"]; ?>" data-position="top" data-tooltip="Ver Bbcode" class="btn-floating halfway-fab waves-effect waves-light green darken-4 tooltipped"><i class="material-icons">visibility</i></a>
                                    ...
                                    <?php } else { ?>
                                        <div class="card-content" style="justify-content: space-around;position: absolute;bottom: 0;width: 100%;display: flex;">
                                            <div class="d-flex align-content-between flex-wrap bntLancamentos">
                                                <a href="Anime.php?idInserido=<?php echo $linha["Pk"]; ?>" data-position="top" data-tooltip="Ver Bbcode" class="tooltipped">
        ...
        <div class="fixed-action-btn click-to-toggle tooltipped" data-position="left" data-tooltip="Adicionar Descrição" style="bottom: 25px; right: 25px;">
            <a href="./NovoAnime.php" class="btn-floating btn-large green accent-4 waves-effect waves-light">

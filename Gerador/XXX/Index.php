...
<body>
    ...
    <header style="position: fixed; height: 56px !important; z-index: 10; width: 100vw; top:0">
        <nav style="background-color: transparent; box-shadow: none;">
            ...
            <div class="black darken-2">
                ...
                <span class="breadcrumb grey-text lighten-5">Adulto</span>
            </div>
        </nav>
    </header>
    ...
    <main>
        <div Class="row center-align">
            <?php
            if ($idUsuario == 1) {
                $query = " SELECT A.Pk, A.Capa, A.Titulo, U.NomeUsuario , U.Pk As 'PkUsuario' 
                FROM adultos A Join usuarios U ON A.FkUsuario = U.Pk 
                Order By U.Pk, A.Titulo";
            ...
            ?>
                            <div class="col s6 m4 l3" style="justify-content: center;display: flex;">
                                <div class="card small tooltipped" data-position="top" data-tooltip="<?php echo $linha["Titulo"] ?>" style="width: 200px;height: 300;background-image: url('./../../Public/IMG/XXX.jpg'); background-size: 100%; background-repeat: round;  background-color: black">
                                    <?php if ($linha["PkUsuario"] == 1) { ?>
                                        <div class="card-content" style="justify-content: space-around;position: absolute;bottom: 0;width: 100%;display: flex;">
                                            <a href="XXX.php?idInserido=<?php echo $linha["Pk"]; ?>" data-position="top" data-tooltip="Ver Bbcode" class="btn-floating halfway-fab waves-effect waves-light green darken-4 tooltipped"><i class="material-icons">visibility</i></a>
                                    ...
                                    <?php } else { ?>
                                        <div class="card-content" style="justify-content: space-around;position: absolute;bottom: 0;width: 100%;display: flex;">
                                            <div class="d-flex align-content-between flex-wrap bntLancamentos">
                                                <a href="XXX.php?idInserido=<?php echo $linha["Pk"]; ?>" data-position="top" data-tooltip="Ver Bbcode" class="tooltipped">
                ...
                if ($resultado) {
                    if ($resultado->num_rows > 0) {
                        ...
                        ?>
                            <div class="col s6 m4 l3" style="justify-content: center;display: flex;">
                                <div class="card small tooltipped" data-position="top" data-tooltip="<?php echo $linha["Titulo"] ?>" style="width: 200px;height: 300;background-image: url('./../../Public/IMG/XXX.jpg'); background-size: contain; background-repeat: round;  background-color: black">
                                    <div class="card-content" style="justify-content: space-around;position: absolute;bottom: 0;width: 100%;display: flex;">
                                        <a href="XXX.php?idInserido=<?php echo $linha["Pk"]; ?>" data-position="top" data-tooltip="Ver Bbcode" class="btn-floating halfway-fab waves-effect waves-light green darken-4 tooltipped"><i class="material-icons">visibility</i></a>
                                        <a href="Editar.php?idInserido=<?php echo $linha["Pk"]; ?>" data-position="top" data-tooltip="Editar Descrição" class="btn-floating halfway-fab waves-effect waves-light blue darken-4 tooltipped"><i class="material-icons">mode</i></a>
                                        <a onclick="fnDeletaLancamento(<?php echo $linha['Pk']; ?>)" data-position="top" data-tooltip="Excluir Descrição" class="btn-floating halfway-fab waves-effect waves-light red darken-4 tooltipped"><i class="material-icons btn-excluir-item">delete</i></a>
        ...
        <div class="fixed-action-btn click-to-toggle tooltipped" data-position="left" data-tooltip="Adicionar Descrição" style="bottom: 25px; right: 25px;">
            <a href="./NovoXXX.php" class="btn-floating btn-large green accent-4 waves-effect waves-light">

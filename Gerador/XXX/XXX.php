...
<body>
    ...
    <header style="position: fixed; height: 56px !important; z-index: 10; width: 100vw; top:0">
        <nav style="background-color: transparent; box-shadow: none;">
            ...
            <div class="black darken-2">
                ...
                <a class="breadcrumb white-text" href="./Index.php">Adulto</a>
    ...
    <main class="container" style="margin-top: 80px;margin-bottom: 80px;">
        <form class="center-align" action=" https://cliente.####.club/enviar-adultos.php" method="post" target="_blank">
            <textarea id="descrCopia" style="margin-top: -1000px;">
                    <?php
                    $query = " SELECT T.*, S.*, A.* FROM adultos S 
                    ...
                    if ($resultado->num_rows > 0) {
                        while ($linha = $resultado->fetch_assoc()) {
                            ...
                            <div class="col-12 <?php echo $alinhamentoTexto ?> mb-5">
                                ...
                                <b>Idioma: </b><?php echo $linha["Idioma"] ?><br />
                                <b>Legenda: </b><?php echo $linha["Legenda"] ?><br />
                                <b>Categoria: </b><?php echo $linha["Categoria"] ?>
                            </div>
                            ...
                            <div class="col-12 mb-5">
                                <p class="<?php echo $alinhamentoTexto ?>"><?php echo $linha["Elenco"] ?></p>
                            </div>
            ...
            <div class="item-hide">
                <input value="<?php echo $Titulo ?>" type="text" name="name" id="name" />

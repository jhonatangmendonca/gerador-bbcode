...
$query = "SELECT 1 FROM videoaulas WHERE Pk = $idInserido";
...
$query = "SELECT * FROM videoaulas Where Pk = $idInserido";
$resultado = $CONEXAO->query($query);
if ($resultado) {
    while ($linha = $resultado->fetch_assoc()) {
        $Titulo = $linha["Titulo"];
        ...
        $Autor = $linha["Autor"];
        $Formato = $Formato;
        $CodecAudio = $linha["CodecAudio"];
        $CodecVideo = $linha["CodecVideo"];
        $Idioma = $linha["Idioma"];
...
<body>
    ...
    <header style="position: fixed; height: 56px !important; z-index: 10; width: 100vw; top:0">
        <nav style="background-color: transparent; box-shadow: none;">
            ...
            <div class="black darken-2">
                ...
                <a class="breadcrumb white-text" href="./Index.php">Vídeo-Aulas</a>
    ...
    <main class="container" style="margin-top: 80px;margin-bottom: 80px;">
        <form action="gera.php" method="post" class="p-3">
            ...
            <div class="row">
                <div class="input-field col s6">
                    <input value="<?php echo $Screen1 ?>" id="screen1" name="screen1" type="text" class="validate">
                    <label class="active" for="screen1">Screen 1</label>
                </div>

                <div class="input-field col s6">
                    <input value="<?php echo $Screen2 ?>" id="screen2" name="screen2" type="text" class="validate">
            ...
            <div class="row">
                <div class="input-field col s6">
                    ...
                    <select class="browser-default" id="audio" name="audio" required="">
                        <option value="AAC" <?= ($CodecAudio == 'AAC') ? 'selected' : '' ?>>AAC</option>
                        <option value="AC3" <?= ($CodecAudio == 'AC3') ? 'selected' : '' ?>>AC3</option>
                        <option value="AC3/DTS" <?= ($CodecAudio == 'AC3/DTS') ? 'selected' : '' ?>>AC3/DTS</option>
                        <option value="DTS" <?= ($CodecAudio == 'DTS') ? 'selected' : '' ?>>DTS</option>
                        <option value="DTS-HD" <?= ($CodecAudio == 'DTS-HD') ? 'selected' : '' ?>>DTS-HD</option>
                        <option value="DTS-HD-MA" <?= ($CodecAudio == 'DTS-HD-MA') ? 'selected' : '' ?>>DTS-HD-MA</option>
                        <option value="DTS-X" <?= ($CodecAudio == 'DTS-X') ? 'selected' : '' ?>>DTS-X</option>
                        <option value="E-AC-3" <?= ($CodecAudio == 'E-AC-3') ? 'selected' : '' ?>>E-AC-3</option>
                        <option value="FLAC" <?= ($CodecAudio == 'FLAC') ? 'selected' : '' ?>>FLAC</option>
                        <option value="LPCM" <?= ($CodecAudio == 'LPCM') ? 'selected' : '' ?>>LPCM</option>
                        <option value="MPC" <?= ($CodecAudio == 'MPC') ? 'selected' : '' ?>>MPC</option>
                        <option value="MPEG Layer-3 (MP3)" <?= ($CodecAudio == 'MPEG Layer-3 (MP3') ? 'selected' : '' ?>>MPEG Layer-3 (MP3)</option>
                        <option value="OGG" <?= ($CodecAudio == 'OGG') ? 'selected' : '' ?>>OGG</option>
                        <option value="OPUS" <?= ($CodecAudio == 'OPUS') ? 'selected' : '' ?>>OPUS</option>
                        <option value="Outros" <?= ($CodecAudio == 'Outros') ? 'selected' : '' ?>>Outros</option>
                        <option value="PCM" <?= ($CodecAudio == 'PCM') ? 'selected' : '' ?>>PCM</option>
                        <option value="Real Audio (RMVB)" <?= ($CodecAudio == 'Real Audio (RMVB)') ? 'selected' : '' ?>>Real Audio (RMVB)</option>
                        <option value="TrueHD" <?= ($CodecAudio == 'TrueHD') ? 'selected' : '' ?>>TrueHD</option>
                        <option value="Vorbis" <?= ($CodecAudio == 'Vorbis') ? 'selected' : '' ?>>Vorbis</option>
                        <option value="Windows Media Audio" <?= ($CodecAudio == 'indows Media Audio') ? 'selected' : '' ?>>Windows Media Audio</option>
                    </select>
                </div>
                ...
                <div class="input-field col s6">
                    ...
                    <select class="browser-default" id="video" name="video" required="">
                        <option value="DivX" <?= ($CodecVideo == 'DivX') ? 'selected' : '' ?>>DivX</option>
                        <option value="H264" <?= ($CodecVideo == 'H264') ? 'selected' : '' ?>>H264</option>
                        <option value="H265" <?= ($CodecVideo == 'H265') ? 'selected' : '' ?>>H265</option>
                        <option value="M4V" <?= ($CodecVideo == 'M4V') ? 'selected' : '' ?>>M4V</option>
                        <option value="MPEG-1" <?= ($CodecVideo == 'MPEG-1') ? 'selected' : '' ?>>MPEG-1</option>
                        <option value="MPEG-2" <?= ($CodecVideo == 'MPEG-2') ? 'selected' : '' ?>>MPEG-2</option>
                        <option value="Outros" <?= ($CodecVideo == 'Outros') ? 'selected' : '' ?>>Outros</option>
                        <option value="Real Video (RMVB)" <?= ($CodecVideo == 'Real Video (RMVB)') ? 'selected' : '' ?>>Real Video (RMVB)</option>
                        <option value="VC-1" <?= ($CodecVideo == 'VC-1') ? 'selected' : '' ?>>VC-1</option>
                        <option value="VP6" <?= ($CodecVideo == 'VP6') ? 'selected' : '' ?>>VP6</option>
                        <option value="VP9" <?= ($CodecVideo == 'VP9') ? 'selected' : '' ?>>VP9</option>
                        <option value="Windows Media Video" <?= ($CodecVideo == 'Windows Media Video') ? 'selected' : '' ?>>Windows Media Video</option>
                        <option value="XviD" <?= ($CodecVideo == 'XviD') ? 'selected' : '' ?>>XviD</option>
                    </select>
                </div>
            </div>

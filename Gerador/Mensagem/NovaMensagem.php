    ...
    <header style="position: fixed; height: 56px !important; z-index: 10; width: 100vw; top:0">
        <nav style="background-color: transparent; box-shadow: none;">
            ...
            <div class="black darken-2">
                ...
                <a class="breadcrumb white-text" href="./Index.php">Mensagens</a>
                <span class="breadcrumb grey-text lighten-5">Nova Mensagem</span>
            </div>
        </nav>
    </header>
        ...
        <form action="gera.php" method="post" class="p-3">
            ...
            <div class="row">
                <div class="input-field col s12">
                    ...
                    <input type="submit" name="BntCadastrar" id="BntCadastrar" class="btn btn-sm light-blue darken-4" value="Enviar Mensagem">
                </div>
            </div>
        </form>
    </main>
